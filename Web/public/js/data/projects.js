...
export const projects = [
    {
        ...
        description: 'Ziel ist die Entwicklung einer WebApp zur Kapazitätsplanung und Ressourcenübersicht für die Produktionsplanung. Die Anwendung soll Engpässe frühzeitig erkennen, eine transparente Übersicht über die Auslastung von Ressourcen bieten, und mögliche Liefertermine per Knopfdruck bestimmen.',
        bullets: [
    ...
    },
    {
        ...
        bullets: [
            ...
            { label: 'Ergebnis', text: 'Zukunftssichere Modernisierung der Anlage. Steigerung der Prozesseffizienz durch einen optimierten Materialfluss sowie Arbeitserleichterung für die Bediener durch Digitalisierung und verbesserte Usability.' },
        ],
    ...
    },
    {
        ...
        bullets: [
            ...
            { label: 'Ergebnis', text: 'Erfolgreiche Beseitigung eines kritischen Produktionsengpasses. Umstellung von manuellen Logistik- und Datenübergabeprozessen in einen durchgängig automatisierten Ablauf mit messbarer Durchsatzsteigerung.' },
        ],
